...
class FilterControllerTest {
    ...
    void findAll() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/filter/all")
                ...
                .andExpect(jsonPath("$[0].startDate", is("2020-05-12")))
                .andExpect(jsonPath("$[0].endDate", is("2020-06-12")))
                ...
                .andExpect(jsonPath("$[1].startDate", is("2020-05-12")))
                .andExpect(jsonPath("$[1].endDate", is("2020-06-12")))
    ...
    void findById() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/filter/id")
                ...
                .andExpect(jsonPath("$.startDate", is("2021-08-05")))
                .andExpect(jsonPath("$.endDate", is("2021-09-12")))
